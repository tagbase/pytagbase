...
class TagPut200(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagPut200:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagPut200:
        """Create an instance of TagPut200 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagPut200.parse_obj(obj)

        _obj = TagPut200.parse_obj({
            "code": obj.get("code"),
