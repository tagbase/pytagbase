...
from pytagbase.models.tag_submission import TagSubmission  # noqa: E501

class TestTagSubmission(unittest.TestCase):
    """TagSubmission unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagSubmission:
        """Test TagSubmission
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagSubmission`
        """
        model = TagSubmission()  # noqa: E501
        if include_optional:
