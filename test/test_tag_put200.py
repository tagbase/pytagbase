...
from pytagbase.models.tag_put200 import TagPut200  # noqa: E501

class TestTagPut200(unittest.TestCase):
    """TagPut200 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagPut200:
        """Test TagPut200
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagPut200`
        """
        model = TagPut200()  # noqa: E501
        if include_optional:
            return TagPut200(
                code = '200',
